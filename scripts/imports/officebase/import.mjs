// Imports scripts/imports/officebase/import-ready.json into production via
// POST /api/admin/products/import. Category/type/subtype labels in that file
// must exactly match the existing Furniture taxonomy (case-insensitive) so
// products attach to it instead of creating duplicates.
// Run with: PRODUCTS_IMPORT_API_KEY="..." node scripts/imports/officebase/import.mjs
