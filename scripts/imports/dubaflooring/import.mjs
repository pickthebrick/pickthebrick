// Imports scripts/imports/dubaflooring/import-ready.json (8 real Solid Wood
// products from dubaflooring.com) via POST /api/admin/products/import.
// Run with: PRODUCTS_IMPORT_API_KEY="..." node scripts/imports/dubaflooring/import.mjs
